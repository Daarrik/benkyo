export const kanjiList = [
  ...
  { kanji: '吸う', reading: 'すう' },
  { kanji: '詰らない', reading: 'つまらない' },
  { kanji: '閉まる', reading: 'しまる' },
  { kanji: '咲く', reading: 'さく' },
  { kanji: '真っ直ぐ', reading: 'まっすぐ' },
  { kanji: 'お祖母さん', reading: 'おばあさん' },
  { kanji: '涼しい', reading: 'すずしい' },
  { kanji: '其方', reading: 'そちら' },
  { kanji: '厚い', reading: 'あつい' },
  { kanji: 'お兄さん', reading: 'おにいさん' },
  { kanji: 'お姉さん', reading: 'おねえさん' },
  ...
  { kanji: 'Ｙシャツ', reading: 'ワイシャツ' },
  { kanji: '六つ', reading: 'むっつ' },
  { kanji: 'お手洗い', reading: 'おてあらい' },
  { kanji: 'お巡りさん', reading: 'おまわりさん' },
  { kanji: '差す', reading: 'さす' },
